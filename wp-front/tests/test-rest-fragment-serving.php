<?php
/**
 * Standalone PHP Challenge Suite for Finlyzer REST API Fragment Serving (v1.21.0)
 *
...
if (!defined('FINLYZER_VERSION')) {
	define('FINLYZER_VERSION', '1.21.0');
}
...
echo "================================================================\n";
echo "⚡ FINLYZER REST API FRAGMENT SERVING CHALLENGE SUITE (v1.21.0)\n";
echo "================================================================\n\n";
